ECR_REPO := "528451384384.dkr.ecr.us-west-2.amazonaws.com/sample-go-test-app-vaibhav"
...
# aws-okta exec stage-privileged -- treb local -e stage .run/<service>.yml -- chamber exec chamber <service> -- make run
.PHONY: run
run:
	$Qgo run $(PKG)
